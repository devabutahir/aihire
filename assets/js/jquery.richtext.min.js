...
(function ($) {
    $.fn.richText = function (options) {
        ...
        var $editor,
            $toolbarList = $("<ul />"),
            $toolbarElement = $("<li />"),
            $btnBold = $("<a />", { class: "richText-btn", "data-command": "bold", title: settings.translations.bold, html: '<span class="bi bi-type-bold"></span>' }),
            $btnItalic = $("<a />", { class: "richText-btn", "data-command": "italic", title: settings.translations.italic, html: '<span class="bi bi-type-italic"></span>' }),
            $btnUnderline = $("<a />", { class: "richText-btn", "data-command": "underline", title: settings.translations.underline, html: '<span class="bi bi-type-underline"></span>' }),
            $btnJustify = $("<a />", { class: "richText-btn", "data-command": "justifyFull", title: settings.translations.justify, html: '<span class="bi bi-justify"></span>' }),
            $btnLeftAlign = $("<a />", { class: "richText-btn", "data-command": "justifyLeft", title: settings.translations.alignLeft, html: '<span class="bi bi-align-start"></span>' }),
            $btnCenterAlign = $("<a />", { class: "richText-btn", "data-command": "justifyCenter", title: settings.translations.alignCenter, html: '<span class="bi bi-text-center"></span>' }),
            $btnRightAlign = $("<a />", { class: "richText-btn", "data-command": "justifyRight", title: settings.translations.alignRight, html: '<span class="bi bi-align-end"></span>' }),
            $btnOL = $("<a />", { class: "richText-btn", "data-command": "insertOrderedList", title: settings.translations.addOrderedList, html: '<span class="bi bi-list-ol"></span>' }),
            $btnUL = $("<a />", { class: "richText-btn", "data-command": "insertUnorderedList", title: settings.translations.addUnorderedList, html: '<span class="bi bi-list-ul"></span>' }),
            $btnHeading = $("<a />", { class: "richText-btn", title: settings.translations.addHeading, html: '<span class="bi bi-type-h1"></span>' }),
            $btnFont = $("<a />", { class: "richText-btn", title: settings.translations.addFont, html: '<span class="bi bi-file-earmark-font"></span>' }),
            $btnFontColor = $("<a />", { class: "richText-btn", title: settings.translations.addFontColor, html: '<span class="bi bi-pencil"></span>' }),
            $btnBackgroundColor = $("<a />", { class: "richText-btn", title: settings.translations.addBackgroundColor, html: '<span class="bi bi-brush"></span>' }),
            $btnFontSize = $("<a />", { class: "richText-btn", title: settings.translations.addFontSize, html: '<span class="bi bi-body-text"></span>' }),
            $btnImageUpload = $("<a />", { class: "richText-btn", title: settings.translations.addImage, html: '<span class="bi bi-image"></span>' }),
            $btnVideoEmbed = $("<a />", { class: "richText-btn", title: settings.translations.addVideo, html: '<span class="bi bi-camera-video"></span>' }),
            $btnFileUpload = $("<a />", { class: "richText-btn", title: settings.translations.addFile, html: '<span class="bi bi-file-text"></span>' }),
            $btnURLs = $("<a />", { class: "richText-btn", title: settings.translations.addURL, html: '<span class="bi bi-link"></span>' }),
            $btnTable = $("<a />", { class: "richText-btn", title: settings.translations.addTable, html: '<span class="bi bi-table"></span>' }),
            $btnRemoveStyles = $("<a />", { class: "richText-btn", "data-command": "removeFormat", title: settings.translations.removeStyles, html: '<span class="bi bi-recycle"></span>' }),
            $btnCode = $("<a />", { class: "richText-btn", "data-command": "toggleCode", title: settings.translations.code, html: '<span class="bi bi-code"></span>' });
        var $dropdownOuter = $("<div />", { class: "richText-dropdown-outer" });
        var $dropdownClose = $("<span />", { class: "richText-dropdown-close", html: '<span title="' + settings.translations.close + '"><span class="bi bi-times"></span></span>' });
        ...
        function init() {
            ...
            if (!settings.preview) {
                $bottomToolbar.append($("<a />", { class: "richText-undo is-disabled", html: '<span class="bi bi-arrow-counterclockwise"></span>', title: settings.translations.undo }));
                $bottomToolbar.append($("<a />", { class: "richText-redo is-disabled", html: '<span class="bi bi-repeat fa-redo"></span>', title: settings.translations.redo }));
            }
            $bottomToolbar.append($("<a />", { class: "richText-help", html: '<span class="bi bi-question-circle"></span>' }));
            ...
            if (settings.maxlength > 0) {
                ...
                $editor
                    ...
                    .before($("<a />", { class: "richText-length", text: "0/" + settings.maxlength }));
                updateMaxLength($editor.find(".richText-editor").attr("id"));
            }
            if (settings.height && settings.height > 0) {
                $editor.children(".richText-editor, .richText-initial").css({ "min-height": settings.height + "px", height: settings.adaptiveHeight ? "auto" : settings.height + "px" });
                ...
                $editor.children(".richText-editor, .richText-initial").css({ "min-height": height + "px", height: settings.adaptiveHeight ? "auto" : height + "px" });
            } else if (settings.adaptiveHeight) {
                $editor.children(".richText-editor, .richText-initial").css({ height: "auto" });
            }
            if (settings.class) {
        ...
        settings.$editor.find(".richText-help").on("click", function () {
            ...
            if ($editor) {
                ...
                var $content = $("<div />", {
                    html: '<span id="closeHelp" style="display:block;position:absolute;top:0;right:0;padding:10px;cursor:pointer;" title="' + settings.translations.close + '"><span class="bi bi-times"></span></span>',
                });
        ...
        function getVideoCode(url, size) {
            ...
            if (video.platform === "YouTube") {
                ...
                html +=
                    ...
                    size[1] +
                    '" style="' +
                    (responsive === true ? 'position:absolute;width:100%;height:100%;left:0;border:none;overflow:hidden"' : "border:none;overflow:hidden") +
